...
- Use bash script: `$AGENTS_DIR/scripts/utilities/generate_nanobanana.sh`
...
```bash
OUTPUT_DIR="/path/to/save" bash $AGENTS_DIR/scripts/utilities/generate_nanobanana.sh "Your detailed prompt here" output_filename.png
```
