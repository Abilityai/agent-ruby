...
1. **Read Tone of Voice Profile** (if applicable)
   - LinkedIn: Read [User]_LinkedIn_Tone_of_Voice_Profile.md
   - Twitter: Read [User]_Twitter_Tone_of_Voice_Profile.md
   - Threads: Read [User]_Text_Post_Tone_of_Voice_Profile.md
