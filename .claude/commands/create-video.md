...
```
/create-video "Create video about Eugene's perspective on AI agent adoption barriers" instagram
```

### Video from Recent Insights
```
/create-video "Create video summarizing Eugene's latest AI insights from this month" linkedin,youtube
```
...
- Prompt: "Create a 30-second HeyGen video script about [topic]. Use Eugene's unique perspectives from the knowledge base. Follow this structure: Hook (5s) → Insight (20s) → CTA (5s)."
...
2. **Insight (20 seconds)**: Eugene's unique perspective or contrarian take
...
- **Conversational**: Write how Eugene speaks, not academic
...
```
User: /create-video "Eugene's perspective on AI adoption barriers" instagram,linkedin
