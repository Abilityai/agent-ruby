...
### API Credentials
- **Creatomate API Key:** `c1ec8e240f2147a88ff7f2274455edeff873736b73505356de375afa89bcb390c76b4c944b8dbfe5f0cb4a70f12155f5`
- **Template ID:** `cbfb6831-83c4-43da-a8ba-90ef59bcb56a` (Karaoke Subtitles)
- **Cloudinary Cloud:** `dfs5yfioa` (configured in MCP)
...
curl -X POST https://api.creatomate.com/v2/renders \
  ...
  -H "Authorization: Bearer c1ec8e240f2147a88ff7f2274455edeff873736b73505356de375afa89bcb390c76b4c944b8dbfe5f0cb4a70f12155f5" \
  -d '{
...
3. **Wrong file path format for Cloudinary**: Missing `file://` prefix
   - ❌ `uploadRequest: {"file": "/Users/eugene/video.mp4"}`
   - ✅ `uploadRequest: {"file": "file:///Users/eugene/video.mp4"}`
