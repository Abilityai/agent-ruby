...
Call Cornelius in headless mode to generate a complete, long-form article from [User]'s knowledge base. Synthesizes multiple insights into coherent narrative with [User]'s authentic voice.
...
2. **Call Cornelius (Headless Mode)**
   ...
   Apply [User]'s [platform] tone of voice from the profile.
...
Tone: Professional but accessible ([User]'s LinkedIn voice)
Structure: Problem → Insight → Evidence → Application
CTA: Thought-provoking question for comments

Read [User]_LinkedIn_Tone_of_Voice_Profile.md first.
...
Target 1,500 words. [User]'s authentic voice.
```
...
✅ Includes [User]'s unique/contrarian perspectives
...
- Request "[User]'s authentic voice"
