...
3. Track [User]'s thumbnail performance vs competitors
...
**Storage**:
- `$HOME/Library/CloudStorage/.../GeneratedShorts/Thumbnails/Research/`
...
- [ ] Test recommended styles on [User]'s videos
...
4. **Measurable**: Can A/B test findings on [User]'s videos
