...
2. **Generated Shorts folder** - `$CONTENT_DIR/GeneratedShorts`
...
curl -o "$CONTENT_DIR/GeneratedShorts/video-with-captions.mp4" "$VIDEO_URL"
```
...
**API Key:** `${CREATOMATE_API_KEY}` (set in .env)
