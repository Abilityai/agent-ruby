...
**Command:**
```bash
bash /Users/eugene/Dropbox/Cornelius/.claude/skills/blotato-posting/scripts/post.sh \
  "CONTENT_HERE" \
...
### Upload media first:
```bash
bash /Users/eugene/Dropbox/Cornelius/.claude/skills/blotato-posting/scripts/upload-media.sh \
...
- API key location: `/Users/eugene/Dropbox/Cornelius/.claude/skills/blotato-posting/config.json`
