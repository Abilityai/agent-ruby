...
5. Download all generated shorts to **TWO locations**:
   ...
   - Central shorts folder: `/Users/eugene/Library/CloudStorage/GoogleDrive-eugene@ability.ai/My Drive/Eugene Personal Brand/CutShorts`
6. Save metadata (virality scores, captions) to both directories

**Klap API Details:**
- API Key: `kak_K1eQjUgRXr7l7vKDzYOO6u5u`
- Base URL: `https://api.klap.app/v2`
- Python script available: `/Users/eugene/Dropbox/Agents/Ruby/scripts/klap_clipper.py`
...
2. **Submit to Klap:**
   ...
   curl -X POST 'https://api.klap.app/v2/tasks/video-to-shorts' \
     -H 'Authorization: Bearer kak_K1eQjUgRXr7l7vKDzYOO6u5u' \
...
6. **Save to TWO locations:**
   ...
   - Copy each short to `/Users/eugene/Library/CloudStorage/GoogleDrive-eugene@ability.ai/My Drive/Eugene Personal Brand/CutShorts`
...
/Users/eugene/.../Eugene Personal Brand/CutShorts/
└── original_video_name/
